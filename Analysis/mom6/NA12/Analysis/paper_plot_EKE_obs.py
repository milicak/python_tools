...
ds = xr.open_dataset('/Volumes/A1/workdir/milicak/datasets/SSHUGVG/global_EKE.nc')
...
im1 = plt.pcolormesh(ds.longitude,ds.latitude,ds.EKE,
...
plt.savefig('paperfigs/EKE_obs.png', bbox_inches='tight',format='png',dpi=300)
