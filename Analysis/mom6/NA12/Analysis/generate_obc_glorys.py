...
def write_year(year, glorys_dir, segments, is_first_year=False):
    glorys = (
        xarray.open_mfdataset(sorted(glob(os.path.join(glorys_dir, f'GLORYS_REANALYSIS_{year}-*.nc'))))
...
def main():
    first_year = 1996
    glorys_dir = '/Volumes/A1/workdir/milicak/datasets/glorys/'
    output_dir = '/Volumes/A1/workdir/milicak/datasets/MOM6/NA12/OBC/obc_gen/'
    ncrcat_outdir = '/Volumes/A1/workdir/milicak/datasets/MOM6/NA12/OBC/obc_gen/'
    hgrid = xr.open_dataset('/Volumes/A1/workdir/milicak/datasets/MOM6/NA12/ocean_hgrid.nc')
    segments = [
