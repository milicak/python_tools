...
mom_dir = '/Volumes/A1/workdir/milicak/datasets/MOM6/NA12/'
...
for idx, fname in enumerate(ls1):
    ...
    temp_north = temp_north.ffill(dim='locations').ffill(dim='depth')
    salt_north = salt_north.ffill(dim='locations').ffill(dim='depth')
    ...
    ssh_north = ssh_north.ffill(dim='locations').bfill(dim='locations')
