...
#wifs_mon.to_netcdf("/okyanus/users/milicak/dataset/MOM6/NA12/seawifs-clim-1997-2010.nc", format='NETCDF3_64BIT')

# we ran the code above on another machine and saved the file. Open this file up
wifs = xr.open_dataset("/okyanus/users/milicak/dataset/MOM6/NA12/seawifs-clim-1997-2010_whole.nc")
...
ds.to_netcdf('/okyanus/users/milicak/dataset/MOM6/NA12/seawifs-clim.1997.2010.nwa12.nc',
    encoding=encodings,
