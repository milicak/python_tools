...
mask = xr.open_dataset('/okyanus/users/milicak/dataset/MOM6/NA12/ocean_mask.nc')
...
df2 = xr.open_dataset('/okyanus/users/milicak/dataset/MOM6/NA12/ocean_hgrid.nc')
...
rg = scipy.io.netcdf_file('tidal_amplitude_NA12.nc','w')
# Dimensions
