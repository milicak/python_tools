...
topo=xr.open_dataset('ocean_topog.nc')
Omask=xr.open_dataset('ocean_mask.nc')
Lmask=xr.open_dataset('land_mask.nc')
...
new_mask=ice9(400,400,Omask.mask.data,False,False)
newOmask=xr.Dataset()
newLmask=xr.Dataset()
