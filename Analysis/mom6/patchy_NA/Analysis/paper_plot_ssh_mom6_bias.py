...
climwoa = 'SSH_Aviso_mom6_0_5deg.nc'
...
sstbias_plot = plt.pcolormesh(gr.geolon,gr.geolat,data+0.5-sshclim,
...
sstbias_plot = plt.pcolormesh(gr.geolon,gr.geolat,data2+0.5-sshclim,
               vmin=-.5,vmax=.5,cmap='RdBu_r',transform=ccrs.PlateCarree()
                              ,rasterized=True);
...
plt.savefig('paperfigs/ssh_diff.png', bbox_inches='tight',format='png',dpi=300)
