...
def flood_era5_data(era5_file,era5_var,landmask_file, outfile, reuse_weights=False):
 # interp landmask
    ...
    regrid_domain = xesmf.Regridder(landmask, era, 'patch',
...
def main():
    landmask_file = '/okyanus/users/milicak/dataset/MOM6/Arctic_Copernicus/land_mask_v2.nc'
    padded_dir = '/okyanus/users/milicak/dataset/ERA5/Arctic_Copernicus/padded/'
    flood_dir = '/okyanus/users/milicak/dataset/ERA5/Arctic_Copernicus/flooded/'
    keys_list=list(era5_dict)

    for era5_year in range(2009,2010):
        print(era5_year)
