...
# This script converts a MITgcm horizontal grid into a MOM6 horizontal
# grid.

# Both MITgcm and MOM6 horizontal grids use an Arakawa C-grid, with four
# types of points:
...
#    "supergrid", while MITgcm stores them as separate grids.
...
def read_ROMS_grid(roms_grid_filename):
    """Load the MITgcm grid from a NetCDF file."""

    subgrids = ['rho']  # also available: 'vert'
