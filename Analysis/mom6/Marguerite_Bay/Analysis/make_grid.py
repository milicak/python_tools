...
hgrd = xr.open_dataset('~/dataset/MOM6/Marguerite_Bay/margi_v04.nc')
...
rg = scipy.io.netcdf_file('/okyanus/users/milicak/dataset/MOM6/Marguerite_Bay/ocean_hgrid.nc','w')
# Dimensions
