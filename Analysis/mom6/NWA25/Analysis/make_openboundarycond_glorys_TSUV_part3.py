...
params=[]
# params.append({'suffix':'_segment_003','dim0':2,
...
# params.append({'suffix':'_segment_002','dim0':3,
#     'tr_in':'tracers_east','tr_out':root_folder+'obc_ts_east_'+str(year)+'.nc',
#     'uv_in':'uv_east','uv_out':root_folder+'obc_uv_east_'+str(year)+'.nc',
#     'ssh_in':'ssh_east','ssh_out':root_folder+'obc_ssh_east_'+str(year)+'.nc'})
# params.append({'suffix':'_segment_001','dim0':2,
...
params.append({'suffix':'_segment_003','dim0':3,
    'tr_in':'tracers_east','tr_out':root_folder+'obc_ts_east_'+str(year)+'.nc',
    'uv_in':'uv_east','uv_out':root_folder+'obc_uv_east_'+str(year)+'.nc',
    'ssh_in':'ssh_east','ssh_out':root_folder+'obc_ssh_east_'+str(year)+'.nc'})
