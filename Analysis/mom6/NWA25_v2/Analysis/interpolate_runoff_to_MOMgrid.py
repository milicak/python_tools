...
hgrid = xr.open_dataset('~/dataset/MOM6/NWA25_v2/ocean_hgrid.nc')
coast_mask = get_coast_mask('/okyanus/users/milicak/dataset/MOM6/NWA25_v2/ocean_mask.nc')

# for year in range(2009,2018):
for year in range(1996,2007):
    print(year)
    fname = '~/dataset/MOM6/NA12/glofas-era5_NA12_' + str(year) + '.nc'
    out_file = root_folder + 'glofas-era5_NWA25_v2_gridded_' + str(year) + '.nc'
