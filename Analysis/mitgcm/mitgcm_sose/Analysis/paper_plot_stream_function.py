...
c2 = ax2.pcolormesh(df1.XG,df1.YC,ma.masked_equal(df2.stream_function*1e-6,0)
...
ax3.pcolormesh(df1.XG,df1.YC,ma.masked_equal(df3.stream_function*1e-6,0)
                    -ma.masked_equal(df1.stream_function*1e-6,0),
                    vmin=-50,vmax=50,cmap='RdBu_r', #norm=divnorm,
                    transform=ccrs.PlateCarree(), rasterized=True);
...
ax4.pcolormesh(df1.XG,df1.YC,ma.masked_equal(df4.stream_function*1e-6,0)
                    -ma.masked_equal(df1.stream_function*1e-6,0),
                    vmin=-50,vmax=50,cmap='RdBu_r', #norm=divnorm,
                    transform=ccrs.PlateCarree(), rasterized=True);
...
ax5.pcolormesh(df1.XG,df1.YC,ma.masked_equal(df5.stream_function*1e-6,0)
                    -ma.masked_equal(df1.stream_function*1e-6,0),
                    vmin=-50,vmax=50,cmap='RdBu_r', #norm=divnorm,
                    transform=ccrs.PlateCarree(), rasterized=True);
