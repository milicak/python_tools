...
df = xr.open_dataset('/archive/milicak/MITgcm_c65/Projects/Arctic_4km/ncfiles/Exp02_0_SSS.nc')
if AtlorPac == 'Atl':
    dfw = xr.open_dataset('/archive/milicak/MITgcm_c65/Projects/Arctic_4km/ncfiles/Exp02_1_SSS.nc')
elif AtlorPac == 'Atlv2':
    dfw = xr.open_dataset('/archive/milicak/MITgcm_c65/Projects/Arctic_4km/ncfiles/Exp02_3_SSS.nc')
else:
    dfw = xr.open_dataset('/archive/milicak/MITgcm_c65/Projects/Arctic_4km/ncfiles/Exp02_2_SSS.nc')
...
if AtlorPac == 'Atl':
    plt.savefig('paperfigs/sss_mean_Atlantic.png', bbox_inches='tight',format='png',dpi=300)
elif AtlorPac == 'Atlv2':
    plt.savefig('paperfigs/sss_mean_Atlanticv2.png', bbox_inches='tight',format='png',dpi=300)
else:
    plt.savefig('paperfigs/sss_mean_Pacific.png', bbox_inches='tight',format='png',dpi=300)
