...
def setParam(title, day, date, bas, param, simul, dtt, itmrst, idtrst,
	...
	f = open('inp_files/%s%s.str'%(param,str(day).zfill(4)), 'w')
	f.write('$title\n\t%s\n'%title)
	#f.write('\t%s_%s\n' % (date, day))
	...
	f.write('\tintpol = 2\n')		
	f.write('\ttnudge = 300\n')		
	f.write("\tboundn	= 'input/boundn_L1_adj.dat'\n")		
	f.write("\tsaltn	= 'input/saltn_L1.dat'\n")		
	f.write("\ttempn	= 'input/tempn_L1.dat'\n")		
	f.write("\tvel3dn	= 'input/uv3d_L1.dat'\n")
	f.write('$end\n\n')		
	f.write('$bound2\n')
	f.write('\tkbound = \n')
	for nknb in bound2:
	...
	f.write('\tintpol = 2\n')		
	f.write('\ttnudge = 300\n')		
	f.write("\tboundn	= 'input/boundn_L2_adj.dat'\n")		
	f.write("\tsaltn	= 'input/saltn_L2.dat'\n")		
	f.write("\ttempn	= 'input/tempn_L2.dat'\n")		
	f.write("\tvel3dn	= 'input/uv3d_L2.dat'\n")
	f.write('$end\n\n')		
	f.write('$bound3\n')
	f.write('\tkbound = \n')
	for nknb in bound3:
	...
	f.write('\tintpol = 2\n')		
	f.write('\ttnudge = 300\n')		
	f.write("\tboundn	= 'input/boundn_L3_adj.dat'\n")		
	f.write("\tsaltn	= 'input/saltn_L3.dat'\n")		
	f.write("\ttempn	= 'input/tempn_L3.dat'\n")		
	f.write("\tvel3dn	= 'input/uv3d_L3.dat'\n")
	f.write('$end\n\n')		
	f.write('$name\n')
	if day==0:
		f.write("\ttempin = 'input/tempin_%s_000000.dat'\n" % date)
		f.write("\tsaltin = 'input/saltin_%s_000000.dat'\n" % date)
		f.write("\tuvinit = 'input/vel3din_%s_000000.dat'\n" % date)
		f.write("\tzinit = 'input/boundin_%s_000000.dat'\n" % date)
	else:
		f.write("\trestrt = 'restart_files/%s%s.rst'\n" % (simul,str(day-1).zfill(4)))
	# f.write("\twind	= 'input/wp.dat'\n\tqflux  = 'input/tc.dat'\n\train   = 'input/rain.dat'\n\tgotmpa = 'input/gotmturb.nml'\n$end")
	f.write("\twind   = 'input/wp_2020.dat'\n\tqflux  = 'input/tc_2020.dat'\n\train   = 'input/rain_2020.dat'\n\tgotmpa = 'input/gotmturb.nml'\n$end")
	f.close()
