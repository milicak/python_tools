...
# for each station
timeind = 0
expname = '2016-09_ISKI_MARMARA'
tmp_pro = df.loc[df['Cruise']==expname]
stationame = 'M20'  # 'M23' 'K0' 'K2' 'BL1' 'B14' 'B13' 'M1' 'M8' 'MBA' 'M20'
stationames = ['M23', 'K0', 'K2', 'BL1', 'B14', 'B13', 'M1', 'M8', 'MBA',
               'M20']
...
for stationame in stationames:
    ...
    fname = 'obs_ctd/2016_09_'+stationame+'_obs.csv'
    df1.to_csv(fname)
    fname = 'obs_ctd/2016_09_'+stationame+'_uTSS.csv'
    print(fname)
    df2.to_csv(fname)
