...
for fname in fnames:
    fname = fname + 'bias.csv'
    df = pd.read_csv(fname)
    plt.plot(df.Salt_bias*0.8,df.zr_obs);


plt.legend(['2017-08','2018-01','2018-04','2018-08'])
plt.xlim(-2,5);
plt.savefig('paperfigs/salinity_bias_all.png', bbox_inches='tight',format='png',dpi=300)


for fname in fnames:
    fname = fname + 'bias.csv'
    df = pd.read_csv(fname)
    plt.plot(df.Temp_bias*0.8,df.zr_obs);


plt.legend(['2017-08','2018-01','2018-04','2018-08'])
plt.xlim(-2,2);
plt.savefig('paperfigs/temperature_bias_all.png', bbox_inches='tight',format='png',dpi=300)
