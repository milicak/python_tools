...
df = pd.read_excel('20190220_1033_ODV_TMAMVerisi.xlsx',sheet_name='2018data')
...
for stationame in stationames:
    ...
    new_year_day = pd.Timestamp(year=2018, month=1, day=1)
    ...
    fname = 'uTSS_lobc_chunk_'+sdate+'.nos.nc'
    fname1 = '/work/mi19918/Projects/uTSS/Exp_2016_analysis_newTSIC/OUT/*/*/'+fname
    list=sorted(glob.glob(fname1))

    ds = xr.open_dataset(list[0])
    ...
    fname = 'obs_ctd_netcdf_new/2018_04_'+stationame+'_obs.csv'
    df1.to_csv(fname)
    fname = 'obs_ctd_netcdf_new/2018_04_'+stationame+'_uTSS.csv'
    df2.to_csv(fname)
