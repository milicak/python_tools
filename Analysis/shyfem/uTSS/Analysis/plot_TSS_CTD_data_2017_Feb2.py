...
stationames = ['IK1', 'IK2', 'IK3', 'IK4', 'IK5', 'IK6']
for stationame in stationames:
    ...
    fname = 'obs_ctd/2017_02v2_'+stationame+'_obs.csv'
    df1.to_csv(fname)
    fname = 'obs_ctd/2017_02v2_'+stationame+'_uTSS.csv'
    print(fname)
    df2.to_csv(fname)
