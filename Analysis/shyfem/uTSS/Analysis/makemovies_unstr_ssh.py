...
for ind in xrange(fyear,lyear+1):
    ...
    im1=plt.tripcolor(longitude,latitude,grd.element_index,
                      varssh[ind,:],cmap='nice_gfdl',vmin=0,vmax=0.35,shading='gouraud')
    ...
    cb.set_label('$\eta$',rotation=0,y=1.07,labelpad=-45)
    printname = 'gifs/ssh_'+sdate+'.png'
