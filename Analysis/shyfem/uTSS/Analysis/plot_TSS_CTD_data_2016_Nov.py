...
stationames = ['K0', 'K2', 'BL1', 'B14', 'B13', 'M1', 'M8', 'MBA', 'M20']
for stationame in stationames:
    ...
    fname = root_folder+project_name+'/'+expid+'/OUT_2016/'+'uTSS_lobc_chunk_'+sdate+'.nos.nc'
    fname
    ...
    fname = 'obs_ctd/2016_11_'+stationame+'_obs.csv'
    df1.to_csv(fname)
    fname = 'obs_ctd/2016_11_'+stationame+'_uTSS.csv'
    print(fname)
    df2.to_csv(fname)
