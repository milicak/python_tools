...
df1 = xr.open_dataset('/work/opa/mi19918/Projects/uTSS_SHYFEM/forcing_files/uTSS_boundary_valuesL1.nc')
df2 = xr.open_dataset('/work/opa/mi19918/Projects/uTSS_SHYFEM/forcing_files/uTSS_boundary_valuesL2.nc')
df3 = xr.open_dataset('/work/opa/mi19918/Projects/uTSS_SHYFEM/forcing_files/uTSS_boundary_valuesL3.nc')
...
l1l2_ave = -0.41737
# l1l2_ave = w1 * np.nanmean(boundn1) + w2 * np.nanmean(boundn2)
# l1l2_min = w1 * np.nanmin(boundn1) + w2 * np.nanmin(boundn2)

# remove average from boundaries
boundn1a = boundn1 - l1l2_ave
boundn2a = boundn2 - l1l2_ave
boundn3a = boundn3 - 0.0*l1l2_ave
