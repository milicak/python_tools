...
fgshhs = open("/home/milicak/gshhs_2_2_0/gshhs_h.b", "rb")
...
def edgeLength(lat, lon):
  ...
  lat = lat * 180 / math.pi
  lon = lon * 180 / math.pi
  if (lon > 33 and lon < 37.2) and (lat > 33 and lat < 37.2) :
      return 1e4
  else :
      return -1
  # return 100e3
...
# geo file
fgeo = open("eastmed.geo", "w")

# svg file
fsvg = open("eastmed.svg", "w")
