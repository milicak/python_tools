...
sstbias_plot = plt.pcolormesh(gr.x_T,gr.y_T,data2-sssclim,
               vmin=-3,vmax=3,cmap='RdBu_r',transform=ccrs.PlateCarree()
                              ,rasterized=True);
...
ax3 = plt.subplot(3, 1, 3,
                  projection=ccrs.PlateCarree(central_longitude=xoffset))
...
# add colorbar
# fig.colorbar(sstbias_plot, ax=ax3)
...
# ax3.set_xticklabels([-180,-120,-60,0,60,120,180],fontsize=16) 
ax3.set_xticklabels(np.array([-180,-120,-60,0,60,120,180])+xoffset,fontsize=16) 
ax3.set_yticklabels([-90,-60,-30,0,30,60,90],fontsize=16) 
ax3.set_xlabel('Lon', fontsize=16)
ax3.set_ylabel('Lat', fontsize=16)

plt.savefig('paperfigs/sss_bias_diff_new.png', bbox_inches='tight',format='png',dpi=300)
