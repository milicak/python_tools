...
dzwoa = nc_read('/fimm/home/bjerknes/milicak/Analysis/mom/patchy_NA/Analysis/WOA09_ann_theta_cm2m_extrap.nc','DEPTH_bnds');
...
for i in range(0,3):
    ...
    dz=ncread_time(filename,'dht',700,744,nx,ny)
    tempmom_dep=temp*dz
