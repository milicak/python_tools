...
data = xr.open_mfdataset(list, decode_times=False)['fice']
data.to_netcdf('/tos-project1/NS4659K/milicak/data/Pacific2_fice.nc')
#dataref = xr.open_mfdataset(listref, decode_times=False)['fice']
#dataref.to_netcdf('/tos-project1/NS4659K/milicak/data/ctl_fice.nc')
