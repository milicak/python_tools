...
fname = root_dir + 'so_Omon_CESM2_ssp585_r1i1p1f1_gn_206501-210012.nc'

dfs = xr.open_dataset(fname)

root_dir = '/tos-project1/NS9252K/CMIP6/historical/CESM2/r1i1p1f1/'
fname = root_dir + 'so_Omon_CESM2_historical_r1i1p1f1_gn_185001-201412.nc'
...
dfc.to_netcdf('CESM_salt_control.nc')
dfs.to_netcdf('CESM_salt_ssp585.nc')
