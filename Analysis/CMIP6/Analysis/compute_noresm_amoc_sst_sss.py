...
dfs = xr.open_dataset('/archive/milicak/dataset/CMIP6/ssp585/NorESM2-MM/r1i1p1f1/tos_Omon_NorESM2-MM_ssp585_r1i1p1f1_gn_201501-210012.nc')
gr = xr.open_dataset('areacello_Ofx_NorESM2-MM_ssp585_r1i1p1f1_gn.nc')
...
ds.to_netcdf('NorESM_MM_tempSP_ssp585.nc')
ds = tempSTmean.to_dataset(name='sstST')
ds.to_netcdf('NorESM_MM_tempST_ssp585.nc')

# Salinity
dfs = xr.open_dataset('/archive/milicak/dataset/CMIP6/ssp585/NorESM2-MM/r1i1p1f1/sos_Omon_NorESM2-MM_ssp585_r1i1p1f1_gn_201501-210012.nc')
...
ds.to_netcdf('NorESM_MM_saltSP_ssp585.nc')
ds = saltSTmean.to_dataset(name='sssST')
ds.to_netcdf('NorESM_MM_saltST_ssp585.nc')

# MOC
moc = xr.open_dataset('/archive/milicak/dataset/CMIP6/ssp585/NorESM2-MM/r1i1p1f1/msftmz_Omon_NorESM2-MM_ssp585_r1i1p1f1_grz_201501-210012.nc')
amoc = moc.msftmz[:,0,:,:]
amoc26 = amoc.sel(lat=26, method='nearest')
amoc26 = amoc26.groupby('time.year').mean('time')
amoc26time = amoc26.max('lev')*1e-9
amoc26time.to_netcdf('NorESM_MM_amoc_ssp585.nc')
