...
dfs = read_data('gs://cmip6/ScenarioMIP/CSIRO/ACCESS-ESM1-5/ssp585/r1i1p1f1/Omon/tos/gn/')
gr = xr.open_dataset('areacello_Ofx_ACCESS-ESM1-5_ssp585_r1i1p1f1_gn.nc')
...
tempSPmean.to_netcdf('ACCESS_tempSP_ssp585.nc')
tempSTmean.to_netcdf('ACCESS_tempST_ssp585.nc')

# Salinity
dfs = read_data('gs://cmip6/ScenarioMIP/CSIRO/ACCESS-ESM1-5/ssp585/r1i1p1f1/Omon/so/gn/')
...
saltSPmean.to_netcdf('ACCESS_saltSP_ssp585.nc')
saltSTmean.to_netcdf('ACCESS_saltST_ssp585.nc')

# MOC
moc = read_data('gs://cmip6/ScenarioMIP/CSIRO/ACCESS-ESM1-5/ssp585/r1i1p1f1/Omon/msftmz/gn/')
amoc = moc.msftmz[:,0,:,:]
amoc26 = amoc.sel(lat=26, method='nearest')
amoc26 = amoc26.groupby('time.year').mean('time')
amoc26time = amoc26.max('lev')*1e-9
amoc26time.to_netcdf('ACCESS_amoc_ssp585.nc')
