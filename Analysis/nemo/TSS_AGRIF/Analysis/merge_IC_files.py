...
df1['vosaline'].loc[dict(x=slice(0,251))] = df3['so'].isel(x=slice(0,251))
df1['thetao'].loc[dict(x=slice(0,251))] = df3['thetao'].isel(x=slice(0,251))

df1['vosaline'].loc[dict(x=slice(251,650),y=slice(74,200))]=df2['vosaline'].isel(x=slice(251,650),y=slice(74,200))
df1['thetao'].loc[dict(x=slice(251,650),y=slice(74,200))]=df2['thetao'].isel(x=slice(251,650),y=slice(74,200))
