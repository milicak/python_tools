...
root_folder = '/work/opa/mi19918/Projects/nemo/BS/MOC_data/tmp/'
# from 1993 - 2020
...
for ind in np.arange(0,len(ls1)):                                              
    ...
    voltr = voltr.sum('lon')                                                     
    # print(ls1[ind][79:87])
    # outname = '/work/opa/mi19918/Projects/nemo/BS/MOC_data/tmp/moc_meridional_sigma1_BSe3r1_' + ls1[ind][79:87] + '.nc'
    print(ls1[ind][65:73]) 
    outname = '/work/opa/mi19918/Projects/nemo/BS/MOC_data/tmp/moc_meridional_sigma1_BSe3r1_' + ls1[ind][65:73] + '.nc'
