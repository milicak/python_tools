...
for ind in range(0,len(ls1)):
    ...
    sigma2 = xr.apply_ufunc(gsw.sigma2, dfs1.so, dft1.thetao,                  
                            dask='parallelized', output_dtypes=[dfs1.so.dtype])
    df1 = sigma2.to_dataset(name='sigma2')                                      
    # from 1993 - 2019
    # print(ls1[ind][79:87])
    # outname = '/work/opa/mi19918/Projects/nemo/BS/MOC_data/sigma2_BSe3r1_' + ls1[ind][79:87] + '.nc'
    # for 2020
    print(ls1[ind][65:73])
    outname = '/work/opa/mi19918/Projects/nemo/BS/MOC_data/sigma2_BSe3r1_' + ls1[ind][65:73] + '.nc'
