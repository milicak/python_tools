...
for ind in range(0,len(ls1)):
    ...
    voltrU = df.vozocrtx*gr.e3u_0*gr.e2u 
    ...
    Tryreverse_zsum = -Tryreverse_zsum
    ...
    outname = '/work/opa/mi19918/Projects/nemo/BS/MOC_data/moc_depth_zonal_BSe2r2_' + ls1[ind][79:87] + '.nc'
