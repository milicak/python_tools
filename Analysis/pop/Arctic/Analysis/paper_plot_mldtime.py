...
#plt.ylim(17,24) 
plt.show()
plt.savefig('paperfigs/cold_exps_mldMarchtime.eps', format='eps', dpi=1000)    
plt.close(fig)
...
#plt.ylim(17,24) 
plt.show()
plt.savefig('paperfigs/warm_exps_mldMarchtime.eps', format='eps', dpi=1000)    
plt.close(fig)
...
#plt.ylim(17,24)   
plt.show()
plt.savefig('paperfigs/cold_warm_ctrls_mldMarchtime.eps', format='eps', dpi=1000)    
plt.close(fig)